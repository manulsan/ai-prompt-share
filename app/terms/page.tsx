      ...
      <article className="max-w-4xl mx-auto prose prose-invert">
        ...
        <div className="space-y-6 text-white/80">
          <section>
            ...
            <p>
              By accessing and using Share AI Prompts, you accept and agree to
          ...
          <section>
            ...
            <p>
              Share AI Prompts is a platform for sharing and discovering
              AI-generated prompts, ideas, and creative content. The service
              allows users to:
            </p>
            <ul className="list-disc ml-6 space-y-2">
              <li>Create and publish AI prompts</li>
              <li>Browse and search other users' prompts</li>
          ...
          <section>
            ...
            <p>
              ...
              using Google OAuth. You are responsible for:
            </p>
            <ul className="list-disc ml-6 space-y-2">
          ...
          <section>
            ...
            <p>
              The Share AI Prompts platform, including its design, features, and
          ...
          <section>
            ...
            <p>
              ...
              terms or is deemed inappropriate. We may also suspend or terminate
          ...
          <section>
            ...
            <p>
              ...
              notify users of material changes. Your continued use of the
        ...
        <div className="mt-12 p-6 bg-white/5 border border-white/10 rounded-lg">
          <p className="text-white/60 text-sm">
            By using Share AI Prompts, you acknowledge that you have read,
